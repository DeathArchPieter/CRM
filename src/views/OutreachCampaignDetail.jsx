    ...
    <div className="view-container animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '18px', height: '100%' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px' }}>
        ...
        <div className="glass-panel" style={{ padding: '14px 18px', display: 'flex', alignItems: 'center', gap: '14px', borderRadius: '12px' }}>
          ...
          <div>
            <div style={{ fontSize: '10.5px', fontWeight: '600', color: 'var(--text-muted)', textTransform: 'uppercase', display: 'flex', alignItems: 'center' }}>
              Campaign ANP
              <InfoTooltip 
                title="Annualized New Premium (ANP)" 
                content="Total annualized premium volume generated from closed insurance policies in this campaign." 
              />
            </div>
        ...
        <div className="glass-panel" style={{ padding: '14px 18px', display: 'flex', alignItems: 'center', gap: '14px', borderRadius: '12px' }}>
          ...
          <div>
            <div style={{ fontSize: '10.5px', fontWeight: '600', color: 'var(--text-muted)', textTransform: 'uppercase', display: 'flex', alignItems: 'center' }}>
              Campaign FYC
              <InfoTooltip 
                title="First Year Commission (FYC)" 
                content="Direct initial commission revenue generated by this campaign toward your MDRT pacing." 
              />
            </div>
          ...
          <div>
            <div style={{ fontSize: '10.5px', fontWeight: '600', color: 'var(--text-muted)', textTransform: 'uppercase', display: 'flex', alignItems: 'center' }}>
              ...
              <InfoTooltip 
                ...
                content="Targets who accepted an advisory consultation. Moving to Appt Booked automatically prompts address lookup and Google Calendar scheduling." 
              />
            </div>
        ...
        <div className="glass-panel" style={{ padding: '14px 18px', display: 'flex', alignItems: 'center', gap: '14px', borderRadius: '12px' }}>
          ...
          <div>
            <div style={{ fontSize: '10.5px', fontWeight: '600', color: 'var(--text-muted)', textTransform: 'uppercase', display: 'flex', alignItems: 'center' }}>
              Conversion Health
              <InfoTooltip 
                title="Funnel Conversion Efficiency" 
                content="Tracks Appt Rate (Booked / Enrolled) and Case Closing Rate (Closed / Booked)." 
                benchmark="Industry Target: ≥20% Appt, ≥50% Close"
              />
            </div>
